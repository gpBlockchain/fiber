...
| ⚠️ Weak design | 19 (AUDIT-CRYPTO-002, AUDIT-LOGIC-001..008, AUDIT-INPUT-002, AUDIT-AUTH-001, AUDIT-AUTH-002, AUDIT-AUTH-003, AUDIT-MEM-001, AUDIT-MEM-002, AUDIT-ERR-001, AUDIT-ERR-002, AUDIT-STORE-001, AUDIT-INPUT-003) |
| ℹ️ Informational | 1 (AUDIT-DEP-001 — no known CVE in surveyed deps) |
| ⏳ Pending | 9 |

## Next session (S18) — planned

- AUDIT-INPUT-004 — Storage deserialization (bincode) cross-version replay / downgrade (building on STORE-001.F3/F4)
- AUDIT-NET-001 — P2P transport security (tentacle/secio flow control, handshake auth)
- AUDIT-CCH-001 — CCH cross-chain bridge protocol deep audit (LND macaroon + preimage flow privacy, building on LOGIC-008)
- **Highest-priority follow-ups**: INPUT-002-A/B (also unblocks INPUT-003.F1), LOGIC-008-A/B, INPUT-003-A (list-RPC limit cap), AUTH-003-A (fail-closed CORS), ERR-002-A (preimage字面值移除), ERR-001-A/B, STORE-001-A/B, MEM-001-A, AUTH-001-A, AUTH-002-A, LOGIC-007-A
