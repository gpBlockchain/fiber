...
| ⚠️ Weak design | 8 (AUDIT-CRYPTO-002, AUDIT-LOGIC-001..007) |
| ℹ️ Informational | 1 (AUDIT-DEP-001 — no known CVE in surveyed deps) |
| ⏳ Pending | 20 |

## Next session (S7) — planned

- AUDIT-LOGIC-008 — CCH cross-chain HTLC dependency & expiry (renumbered from 007)
- AUDIT-NET-001 / AUDIT-NET-002 — Tentacle network layer (message auth, rate limit, peer identity, Sybil)
- Pending PoC follow-ups (LOGIC-007-FOLLOWUP-A highest priority)
